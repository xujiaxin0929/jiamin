...
+function ($) {
  ...
  SwiperBG.prototype.resetSize = function () {
    ...
    if (_width > 767) {
      if (_width / _height > 1920 / 693) {
        var _w = _width;
        var _h = Math.round(_width * 693 / 1920);
        $bgs.css({
          left: 0,
        ...
        var _w = Math.round(_height * 1920 / 693);
        var _h = _height;
        $bgs.css({
  ...
  $(function () {
    Plugin.call($('#gourmetChannel_swiper'));
  });
}(jQuery);
//# sourceMappingURL=../maps/gourmetChannelVideo_swiper.js.map
